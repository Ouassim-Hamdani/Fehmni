  ...
  if(variant === 'colored'){
    ...
    searchBar=<div className='md:w-96 w-80 flex justify-center' style={{background: 'linear-gradient(270deg, #3799F3 0%, #5785CA 100%)',borderRadius:65,paddingBottom:10,paddingLeft:5,display:'flex',gap:2,justifyContent:'center'}}>  
      ...
      searchBar=<div className='md:w-96 w-80 flex justify-center' style={{background: 'white',borderRadius:65,paddingBottom:10,paddingLeft:5,display:'flex',gap:2,justifyContent:'center'}}>  
        <TextField id='subject' label='Subject' variant='standard' value={subject} onChange={handleSubjectChange} size='small' InputLabelProps={{style:{color:'#2E2E2E'}}} InputProps={{disableUnderline: true}} className="w-24 ml-4 md:text-xs text-[10px]" sx={{input:{color:'white',fontFamily:'Open Sans',fontWeight:600}}}/>
        <div style={{width:1, height:20,marginTop:18, marginRight:15, background:'#2E2E2E'}}/>
        <TextField id='wilaya' label='Wilaya' variant='standard' value={wilaya} onChange={handleWilayaChange} size='small' InputLabelProps={{style:{color:'#2E2E2E'}}} InputProps={{disableUnderline: true}} className="w-24 md:text-xs text-[10px]" sx={{input:{color:'white',fontFamily:'Open Sans',fontWeight:600}}}/>
        <div style={{width:1, height:20,marginTop:18, marginRight:15, background:'#2E2E2E'}}/>
