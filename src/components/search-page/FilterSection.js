...
const FilterSection = () => {
  ...
  return (
    <div style={{display: 'flex', fontFamily:'Open Sans', fontSize: 14, fontWeight: 500, justifyContent:'space-evenly'}}>
      <div style={{display: 'flex',flexDirection: 'column', alignItems:'flex-start',gap:4}}>
        <div>Time</div>
        <div style={{display:'flex', alignItems:'center', gap:15}}>
          From
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DatePicker label=" " variant='inline' onChange={timeFromUpdated} inputFormat='DD/MM/YYYY' InputProps={{disableUnderline: true}} value={timeFrom} renderInput={(params) => <TextField {...params} variant='standard' size='small' sx={{input:{color:'#2E2E2E',fontSize:12,fontFamily:'Open Sans',fontWeight:600}, backgroundColor:'white',borderRadius: 7,height: 50 , paddingRight: 2, paddingLeft: 2, width: 74}}/>}/>
          </LocalizationProvider>
          to
          <LocalizationProvider dateAdapter={AdapterDayjs}>
            <DatePicker label=" " variant='inline' onChange={timeToUpdated} inputFormat='DD/MM/YYYY' InputProps={{disableUnderline: true}} value={timeTo} renderInput={(params) => <TextField {...params} variant='standard' size='small' sx={{input:{color:'#2E2E2E',fontSize:12,fontFamily:'Open Sans',fontWeight:600}, backgroundColor:'white',borderRadius: 7, height: 50, paddingRight:2,paddingLeft:2,width:74}}/>}/>
          </LocalizationProvider>
        </div>
      </div>
      <div style={{display: 'flex',flexDirection: 'column', alignItems:'flex-start',gap:4}}>
        ...
        <div style={{display:'flex', alignItems:'center'}}>
          <TextField variant='standard' value={subject} onChange={subjectUpdated} select InputProps={{disableUnderline: true}} sx={{input:{color:'#2E2E2E',fontSize:12,fontFamily:'Open Sans',fontWeight:600}, backgroundColor:'white',borderRadius: 35,height: 40, paddingTop:1 , paddingRight: 2, paddingLeft: 2, width: 200}}>
